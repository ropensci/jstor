...
```{r}
meta_data <- find_metadata(file_path = jstor_example("sample_with_references.xml"))
```
...
- article_id *(chr)*: The article id, either a combination of digits (`pub-id-type="jstor"`) or a DOI (`pub-id-type="doi"`).
