...
```{r}
meta_data <- jst_get_article(file_path = jstor_example("sample_with_references.xml"))
```
...
```{r, results='asis'}
authors <- jst_get_authors(jstor_example("sample_with_references.xml"))
kable(authors)
```
...
## jst_get_references
```{r}
references <- jst_get_references(jstor_example("sample_with_references.xml"))
...
## jst_get_footnotes
```{r, results='asis'}
jst_get_footnotes(jstor_example("sample_with_references.xml")) %>% 
  kable()
```
...
```{r, results='asis'}
footnotes <- jst_get_footnotes(jstor_example("sample_with_footnotes.xml"))
...
```{r, results='asis'}
full_text <- jst_get_full_text(jstor_example("sample_full_text.txt"))
full_text %>% 
...
```{r, results='asis'}
jst_get_book(jstor_example("sample_book.xml")) %>% knitr::kable()
```
...
```{r}
chapters <- jst_get_chapters(jstor_example("sample_book.xml"))
...
```{r}
author_chap <- jst_get_chapters(jstor_example("sample_book.xml"), authors = TRUE) 
```
